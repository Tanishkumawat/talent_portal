    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="row ">
                    <form action="/CollegeManagement/setFkey" method="post"style="margin-left: 10%;" >

                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="Facultyeno" placeholder="Enter Faculty Enrollment " required class="form-txt" value="${requestScope.enrollment}" >
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="Faculty-Name" placeholder="Enter Name" required class="form-txt"value="${requestScope.fname}">
                            </div>
                            <div class="col-6">
                                <input type="text" name="Contact-no" placeholder="Enter Contact number" required class="form-txt" value="${requestScope.contact}">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="Email-ID" placeholder="Enter Email" required class="form-txt" value="${requestScope.email}">
                            </div>
                            <div class="col-6">
                                <input type="text" name="Dob" placeholder="Enter Date Of Birth (dd/mm/yyyy)" required class="form-txt" value="${requestScope.dob}">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="Department" placeholder="Enter Department" required class="form-txt" value="${requestScope.department}">
                            </div>
                            <div class="col-6">
                                <input type="text" name="Position" placeholder="Enter Position" required class="form-txt" value="${requestScope.position}">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="Join-Date" placeholder="Enter Joining Date (dd/mm/yyyy)" required class="form-txt" value="${requestScope.jdate}">
                            </div>
                            <div class="col-6">
                                <input type="text" name="Salary" placeholder="Enter Salary" required class="form-txt" value="${requestScope.salary}">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-6">
                                <input type="text" name="Experience" placeholder="Enter Exerience" required class="form-txt" value="${requestScope.experience}">
                            </div>
                            <div class="col-6">
