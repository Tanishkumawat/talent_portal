...
<div class="container">
    ...
    <p class="text-white fs-4" style="margin-top: 1rem; margin-bottom: 1rem;">Faculty Search <input type="text" id="searchInput" onkeyup="searchTable()" placeholder="Search for Student.." class="search-box"></p> 
